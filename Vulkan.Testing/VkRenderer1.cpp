...
//
//	// Physical device families
//	auto queue_family_count = 0u;
//	vkGetPhysicalDeviceQueueFamilyProperties(m_PhysicalDevices[0], &queue_family_count, NULL);
//
//	std::vector<VkQueueFamilyProperties> queue_props(queue_family_count);
//	vkGetPhysicalDeviceQueueFamilyProperties(m_PhysicalDevices[0], &queue_family_count, queue_props.data());
//
...
//	queue_info.queueFamilyIndex = m_QueueFamilyIndex;
//
//	// Create device
...
//	std::vector<VkBool32> support_present(m_QueueFamilyProperties.size());
//	for (uint32_t i = 0; i < support_present.size(); i++)
//	{
//		vkGetPhysicalDeviceSurfaceSupportKHR(m_PhysicalDevices[0], i, m_VkSurface, &support_present[i]);
//	}
//
...
//	}
//
//	m_QueueFamilyIndex = graphics_queue_family_index;
//
//	// Keep
//	std::cout << "Fuck\n";
//}
